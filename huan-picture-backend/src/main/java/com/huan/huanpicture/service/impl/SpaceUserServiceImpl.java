...
import com.huan.huanpicture.model.dto.spaceuser.SpaceUserAddRequest;
import com.huan.huanpicture.model.dto.spaceuser.SpaceUserQueryRequest;
...
import com.huan.huanpicture.model.vo.SpaceUserVO;
...
import com.huan.huanpicture.mapper.SpaceUserMapper;
...
* @createDate 2025-12-08 21:00:00
*/
@Service
public class SpaceUserServiceImpl extends ServiceImpl<SpaceUserMapper, SpaceUser>
    ...
    @Override
    public void removeSpace(DeleteRequest deleteRequest) {
        LambdaQueryWrapper<SpaceUser> queryWrapper = new LambdaQueryWrapper<>();
        Long spaceId = deleteRequest.getId();
        queryWrapper.eq(SpaceUser::getSpaceId, spaceId);

        // 添加日志输出，确认删除条件
        System.out.println("准备删除spaceId=" + spaceId + "的记录");

        // 检查是否有匹配的记录
        long count = this.count(queryWrapper);
        System.out.println("找到匹配的记录数: " + count);
