...
import com.huan.huanpicture.enums.SpaceLevelEnum;
...
import com.huan.huanpicture.mapper.SpaceMapper;
...
//    private DynamicShardingManager dynamicShardingManager;
    ...
    public void validSpace(Space space, boolean add) {
        ...
        if (add) {
            ThrowUtils.throwIf(StrUtil.isBlank(spaceName) || spaceName.length() > 30, ErrorCode.PARAMS_ERROR, "空间名称不为空,且不能超过30位");
            ThrowUtils.throwIf(spaceLevelEnum == null, ErrorCode.PARAMS_ERROR, "空间级别不存在");
            ThrowUtils.throwIf(spaceTypeEnum == null, ErrorCode.PARAMS_ERROR, "空间类别不能为空");
        }
